...
export const seedRecipes: SeedRecipe[] = [
  ...
  {
    id: createSeedUuid("31000000", 10),
    title: "Крем карамел",
    slug: "krem-karamel",
    description: "Нежен домашен крем с яйца, мляко, ванилия и златист карамел.",
    imageUrl: "/images/recipes/krem-karamel.png",
  ...
  {
    id: createSeedUuid("31000000", 11),
    title: "Сладък салам",
    slug: "sladak-salam",
    description: "Лесен десерт без печене с бисквити, какао, масло и орехи.",
    imageUrl: "/images/recipes/sladak-salam.png",
  ...
  {
    id: createSeedUuid("31000000", 14),
    title: "Пилешка супа",
    slug: "pileshka-supa",
    description: "Топла пилешка супа със зеленчуци, фиде и нежна застройка.",
    imageUrl: "/images/recipes/pileshka-supa.png",
  ...
  },
  {
    ...
    imageUrl: "/images/recipes/parzheni-filiyki.png",
  ...
  },
  {
    ...
    imageUrl: "/images/recipes/sarmi-s-kiselo-zele.png",
  ...
  },
  {
    ...
    imageUrl: "/images/recipes/ovcharska-salata.png",
  ...
  {
    id: createSeedUuid("31000000", 20),
    title: "Баница с праз",
    slug: "banitsa-s-praz",
    description: "Ароматна домашна баница с праз, сирене и хрупкави кори.",
    imageUrl: "/images/recipes/banitsa-s-praz.png",
